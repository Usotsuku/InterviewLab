...
export { IlDeviceSectionComponent } from './device-section/device-section.component';
export { IlAboutSectionComponent } from './about-section/about-section.component';
export { IlDeleteAccountSectionComponent } from './delete-account-section/delete-account-section.component';
